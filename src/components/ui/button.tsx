...
const buttonVariants = cva(
  "inline-flex h-10 items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-sm shadow-emerald-900/20 hover:bg-primary/90",
        secondary: "bg-emerald-50 text-emerald-900 hover:bg-emerald-100",
        outline: "border border-input bg-background hover:border-emerald-200 hover:bg-accent hover:text-accent-foreground",
